...
async def uzb(message: types.Message):
    ...
    if message.text == "Юридик масалалар":
        try:
            await message.reply_photo("https://t.me/rasmlarpalata/22")
        except:
    ...
    if message.text == "Бизнес режа тайёрлаш":
        try:
            await message.reply_photo("https://t.me/rasmlarpalata/25")
        except:
            await message.reply("Rasm o'chirib tashlangan...")
        await message.answer("📊Хусусий тадбиркорликни ривожлантиришнинг самарали йўналишларини аниқлаш мақсадида ички ва ташқи бозорни мунтазам ўрганиб бориш; 📈💵💸\n\n"
                             ...
                             "📑📈📊“YERELEKTRON” ва “E-IJRO-AUKSION” электрон автоматлаштирилган тизимларидан фойдаланишда маслаҳат ва маълумот бериш - 35", reply_markup=kb.mainmenu)
    if message.text == "🔙 Орқага":
