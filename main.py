...
#photo = InputFile("kurgazma.jpg", 'rb')
...
async def uzb(message: types.Message):
    ...
    if message.text == "Юридик масалалар":
        await message.reply_photo("https://t.me/rasmlarpalata/11")
        await message.reply("Тадбиркорлик субъектлари ҳуқуқларини ҳимоя қилиш сектори қуйидаги асосий йўналишлар бўйича фаолияти юритилишида бошчилик қилади:\n\n"
                                ...
                                "💥Лизинг шартномаси бўйича қарздорликни ундириш бўйича критилган даво аризалар сони  - 9000\n\n"
    ...
    if message.text == "Экспортга кўмаклашиш":
        await message.reply_photo("https://t.me/rasmlarpalata/13")
